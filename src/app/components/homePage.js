    ...
    <main className="min-h-screen bg-gradient-to-b from-cyan-500 to-zinc-800">
      ...
      <section className="section-padding p-4 pb-20 pt-20">
        <div className="container-section mb-8">
          <div className="text-center mb-16">
            <h2 className="text-heading font-extrabold text-gray-800 text-8xl mb-4">Our Security Services</h2>
            <p className="text-body-large text-4xl text-teal-300 max-w-xl mx-auto">
      ...
      <section className="section-padding p-4 pb-20 pt-20">
        <div className="container-section">
          <div className="text-center mb-16">
            <h2 className="text-heading font-extrabold text-white text-6xl md:text-8xl mb-4">Industries We Serve</h2>
            <p className="text-body-large text-xl md:text-2xl text-teal-200 max-w-xl mx-auto">
            ...
            {industries.map((industry, index) => (
              <Card key={index} className="card-gradient hover:shadow-glow transition-all duration-300 group cursor-pointer">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-4xl mb-2">{industry.title}</h3>
...
//   return (
//     <main className="min-h-screen bg-gradient-to-b from-brand-teal to-base-charcoal">
//       {/* Hero Section */}
//       <section className="section-padding  relative overflow-hidden">
//         {/* <div className="absolute inset-0 bg-background/80" /> */}
//         <div className="container-section relative my-4 mx-8">
...
//               <span className="text-black"> Jamaica</span>
//             </h1> */}
//             <h1 className="text-hero text-base-white text-2xl mb-4">
//               Smart Security Solutions for <span className="text-brand-teal"> Jamaica</span>
//               </h1>
//             <p className="text-body-large text-base-white max-w-2xl mx-auto">
//               Protecting homes and businesses with cutting-edge CCTV, access control, 
//               and alarm systems. Professional installation services.
//             </p>
...
//         <div className="container-section mb-8">
//           <div className="text-center mb-16">
//             <h2 className="text-heading font-extrabold text-brand-teal text-2xl mb-4">Our Security Services</h2>
//               <p className="text-body-large text-base-charcoal max-w-2xl mx-auto">
//               Comprehensive security solutions tailored to protect what matters most to you
//             </p>
//           </div>
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
...
//         <div className="container-section">
//           <div className="text-center mb-16">
//             <h2 className="text-heading font-extrabold text-base-white text-2xl mb-4">Industries We Serve</h2>
//             <p className="text-body-large text-base-white/80 max-w-2xl mx-auto">
//               Specialized security solutions for different sectors across Jamaica
//             </p>
//           </div>
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
...
//                 <CardContent className="p-6 text-center">
//                   <div className="mx-auto mb-4 w-14 h-14 bg-accent/10 rounded-lg flex items-center justify-center group-hover:bg-accent/20 transition-colors">
//                    <industry.icon className="h-7 w-7 text-brand-teal" />
//                   </div>
